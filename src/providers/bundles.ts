...
const BUNDLES: readonly ChannelBundle[] = [
  ...
  },
  {
    id: "tubes",
    name: "More big tubes",
    description: "The next tier of large general-audience tubes.",
    icon: "tubes",
    systemImage: "play.rectangle",
    sortOrder: 2,
    members: () => ["spankbang", "tube8", "youjizz", "porntrex", "pornhat", "perfectgirls"],
    sortOptions: BUNDLE_SORT_OPTIONS,
    orientation: false,
  },
  {
    ...
    sortOrder: 3,
    members: () => ["erome", "redgifs", "shooshtime", "tokyomotion", "xxthots"],
    sortOptions: BUNDLE_SORT_OPTIONS,
    orientation: false,
  },
  {
    ...
    sortOrder: 4,
    members: () => ["ph-shorties", "tikporn", "viralxxxporn", "clapdat"],
    sortOptions: BUNDLE_SORT_OPTIONS,
    orientation: false,
  },
  {
    ...
    sortOrder: 5,
    members: () => ["hentaihaven", "rule34video", "rule34gen"],
    sortOptions: BUNDLE_SORT_OPTIONS,
    orientation: false,
  },
  {
    ...
    sortOrder: 6,
    members: () => ["javtiful", "vjav", "hsex", "tokyomotion"],
    sortOptions: BUNDLE_SORT_OPTIONS,
    orientation: false,
  },
  {
    id: "fetish",
    name: "Fetish & kink",
    description: "Fetish, kink, and specialist catalogues.",
    icon: "fetish",
    systemImage: "link",
    sortOrder: 7,
    members: () => ["heavyfetish", "hypnotube", "freeuseporn"],
    sortOptions: BUNDLE_SORT_OPTIONS,
    orientation: false,
  },
];
